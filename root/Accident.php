...
<title> Accident list of Hajji </title>
...
<body>
    ...
    <h3 align="center" style="color: #4B088A"> Accident list of Hajji </h3>
...
<?php
    include('Config.php');
      $sql = "SELECT a.HID,a.First_name,a.Last_name,a.Passport_No,a.Emergency_Contact_No,h.Permanent_Address FROM accident a,hajjis h WHERE a.HID=h.HID"; 
