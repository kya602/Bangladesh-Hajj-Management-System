...
<body>
    ...
    <h3 align="center" style="color: #4B088A"> Umrah Packages</h3>
...
<?php
    include('Config.php');
      $sql = "SELECT p.Package_ID,a.Agency_Name,p.Year,p.Cost_approximate_TK FROM packages p,hajj_agency a WHERE a.Agency_ID=p.Agency_ID and Type like 'Umrah'"; 
